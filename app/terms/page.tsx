...
const sections: TermSection[] = [
  {
    ...
    note: "For any service or training issues, please contact us using the details provided below. If unresolved, you may contact the DVSA (https://www.gov.uk/contact-dvsa). This does not affect your statutory rights.",
  },
  {
